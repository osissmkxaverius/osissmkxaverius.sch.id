      ...
      <Container>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-y-10 md:gap-y-0">
          <div className="flex flex-col space-y-3 w-full lg:col-span-2">
            ...
            <p className="text-desc text-base md:text-sm lg:text-base font-medium">OSIS merupakan organisasi resmi di tingkat sekolah menengah, seperti SMP dan SMA, yang mewadahi para siswa untuk mencapai tujuan bersama. Organisasi ini memiliki struktur kepengurusan yang terdiri dari Ketua, Wakil Ketua I & II, Sekretaris, Wakil Sekretaris, Bendahara, Wakil Bendahara, dan Seksi-Seksi Bidang lainnya.
            Pada periode 2024, OSIS/OSISKA SMK Xaverius Palembang dipimpin oleh Florensia Regitha Aprilianty dan beranggotakan 40 orang. </p>
