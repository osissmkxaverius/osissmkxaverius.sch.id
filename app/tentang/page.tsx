      ...
      <Container>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-y-10 md:gap-y-0">
          <div className="flex flex-col space-y-3 w-full lg:col-span-2">
              ...
              <p className="text-desc text-base md:text-sm lg:text-base font-medium">OSIS merupakan kependekan dari Organisasi Siswa Intra Sekolah. Organisasi ini berada di tingkat sekolah dan dibentuk di sekolah menengah yaitu SMP dan SMA. Organisasi ini menjadi wadah berkumpulnya para siswa untuk mencapai tujuan tertentu. Organisasi ini terdiri dari susunan kepengurusan yang terdiri dari Ketua, Wakil Ketua, Sekretaris, Wakil Seketaris I & II, Bendahara, Wakil Bendahara dan Seksi-Seksi Bidang lainnya.  Kami OSIS/OSISKA SMK Xaverius Palembang periode 2024 beranggota 40 orang diketuai oleh Febri Florensia Regitha Aprilianty.</p>
