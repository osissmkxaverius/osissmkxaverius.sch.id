      ...
      <section className="py-10 md:py-10 lg:py-10 overflow-hidden">
        <div className="flex flex-col md:flex-row md:items-center justify-between md:space-x-2  md:space-y-0">
          <div className="md:w-3/4 lg:w-1/2 space-y-3">
            <h1 className="font-black text-4xl  lg:text-5xl ">MPK & OSIS/OSISKA SMK Xaverius Palembang</h1>
            <p className="text-desc text-base md:text-sm lg:text-base font-medium">Selamat datang di website resmi MPK & OSIS/OSISKA SMK Xaverius Palembang. Website ini berisi informasi tentang MPK & OSIS/OSISKA SMK  Xaverius Palembang periode 2024.</p>
